...
import CSSAnimatedBook from "@/components/Common/CSSAnimatedBook";
  ...
  const faqCategories = [
    {
      ...
      questions: [
        {
          q: 'What is Saarthi4u?',
          a: 'Saarthi4u is a student-focused educational platform dedicated to guiding students and parents toward the right academic and career opportunities. Backed by experienced counsellors and strong collaborations with multiple colleges and universities, Saarthi4u provides personalized admission guidance, career counselling, and end-to-end support throughout the admission journey.',
        },
        {
          q: 'Is Saarthi4u an admission agency or university?',
          a: 'No, Saarthi4u is neither a university nor an admission agency. It is a modern educational guidance platform built to help students navigate their admission and career journey with clarity and confidence. With expert counsellors, strong college partnerships, and a specialized approach for engineering and management aspirants, Saarthi4u helps students explore top colleges, compare courses, understand fees and placements, and make informed career decisions confidently.',
        },
        {
          q: 'How does Saarthi4u’s college partnership work for admissions?',
          a: 'We’re officially tied up with multiple colleges across India to ensure the students—and engineering aspirants get authentic, data-backed seat prediction and Branch counselling without getting scammed by expensive agents',
        },
      ],
    },
    {

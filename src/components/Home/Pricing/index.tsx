        ...
        <motion.div {...bottomAnimation}>
          <div className="text-center pb-6">
            <div className="inline-flex items-center bg-heroBg dark:bg-midnight_text dark:bg-semidark rounded-xl p-2">
              <button
                className={`text-17 font-normal text-midnight_text dark:text-white py-3 px-7 rounded-xl ${tabConfig.planType === "Monthly"
              ...
              <button
                className={`text-17 font-normal text-midnight_text dark:text-white py-3 px-7 rounded-xl ${tabConfig.planType === "Annually"
                    ? "bg-white text-darkmode dark:bg-darkmode"
                    : ""
                  }`}
                onClick={() =>

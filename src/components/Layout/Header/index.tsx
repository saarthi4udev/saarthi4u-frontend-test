    ...
    >
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) flex justify-between lg:items-center xl:gap-16 lg:gap-8 px-4 py-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="#"
            className="hidden lg:flex items-center bg-primary border border-primary hover:border-primary dark:text-white text-white px-4 py-2  gap-2 rounded-lg text-sm font-semibold hover:bg-transparent hover:text-primary dark:hover:text-primary"
            onClick={() => {
              setIsSignInOpen(true);
            }}
          >
            Sign In
            <Icon icon="solar:arrow-right-linear" width="1" height="18" />
          </Link>
          {isSignInOpen && (
            <div
              ref={signInRef}
          ...
          <Link
            href="#"
            className="hidden lg:flex items-center border border-primary dark:hover:border-primary bg-transparent dark:text-primary text-primary  px-4 py-2  gap-2 rounded-lg text-sm font-semibold hover:bg-primary hover:text-white dark:hover:text-white"
            onClick={() => {

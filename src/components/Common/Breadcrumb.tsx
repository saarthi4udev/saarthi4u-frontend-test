...
const Breadcrumb: React.FC<BreadcrumbProps> = ({
  ...
  return (
    <div className="dark:bg-darkmode relative z-10 overflow-hidden pb-15 pt-30 md:pt-32.5 lg:pt-40">
        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4">
            <div className="text-center">
              ...
              <p className="text-gray-900 dark:text-gray-300 mb-5 text-base">
                {pageDescription}
              </p>
              ...
              <ul className="flex items-center justify-center gap-2.5">
                ...
                <li>
                  <p className="text-gray-500 dark:text-gray-400 flex items-center gap-2.5 text-base font-medium">
